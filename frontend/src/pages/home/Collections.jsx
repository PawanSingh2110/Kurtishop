...
const collect = [
  {
    image: "https://www.pehrin.com/cdn/shop/collections/IMG_5827.jpg?v=1749549219&width=750",
    name: "Pooh",
    link: "/category/pooh",
  },
  {
    image: "https://www.pehrin.com/cdn/shop/collections/CEFEEAB4-7E24-4697-949F-CFF4DE1B88F1.jpg?v=1749549175&width=750",
    name: "Naina",
    link: "/category/naina",
  },
  {
    image: "https://www.pehrin.com/cdn/shop/collections/FABB8675-712F-4340-872E-2CB63FBE709F.jpg?v=1749549200&width=750",
    name: "Geet",
    link: "/category/geet",
  },
  {
    image: "https://www.pehrin.com/cdn/shop/files/Sunhari_Apsara_in_golden_bloom_Kurti_Comment_sunhari_for_links_fashion_blogger_style_outfit_30_days_of_outfit_30_daychallenge_lifestyle_story_City_story_life_vlog_fashion_makeup_Cityv.jpg?v=1749398576",
    name: "Alisha",
  ...
  return (
    <div className="mb-10 px-4">
      ...
      <div className="hidden lg:flex overflow-x-auto gap-10  py-4 scrollbar-hidden">
        {collect.map((item, i) => (
          <div key={i} className="min-w-[330px] max-w-[300px] flex-shrink-0 transition-transform duration-700 hover:-rotate-2">
            <Link to={item.link}>
